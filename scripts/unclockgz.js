...
const SunClock = (function() {
	...
	const textReplacements = {
		...
		'morningGlareZone' : 'Morning Glare Zone',
		'glareZoneEnd' : 'End of Glare Zone',
		'morning' : 'Morning',
		'solarNoon' : ' Solar Noon',
		'afternoon' : 'Afternoon',
		'glareZone' : 'Start of Glare Zone',
		'eveningGlareZone' : 'Evening Glare Zone',
	...
	function updateDynamicTheme() {
		...
		if (sunTimes) {
			...
			let isDark = ((currentPeriod <= 2) || (currentPeriod >= 13)) ? true : false;
